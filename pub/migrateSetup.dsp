<html><head><title>Migrate your SAP Adapter 4.6 setup to Adapter for SAP version 10.1</title>
  ...
  <body>
    <h1>Migrate your IBM webMethods Adapter 4.6 for SAP setup to IBM webMethods Adapter 10.1 for SAP</h1>

    <ul>
      <li><a href="/WmSAP/">Back to IBM webMethods Adapter 10.1 for SAP Home Page</a></li>
    </ul>

    <p>This form can be used to automatically migrate your IBM webMethods Adapter 4.6 for SAP setup for usage with IBM webMethods Adapter 10.1 for SAP version.</p>
    <p>The automatic migration process covers items 3 to 8 from
      section <em>Compatibility Considerations</em> from the IBM webMethods Adapter 10.1 for SAP Installation Guide, available from the
      <a href="https://docs.webmethods.io/">IBM Documentation
	Web site</a>.</p>
    <div class="note">
	...
	You do so from the IBM webMethods Adapter 4.6 for SAP Administrator UI at
	...
	to the 10.1 directory
	<code><em>IntegrationServer</em>/packages/WmSAP/config/<code></li>
      <li>If you haven't organized your IBM webMethods Adapter 4.6 for SAP based
	...
	<em>Routing Rules</em> do so by now: 
      ...
      <li>Install your IBM webMethods Adapter 4.6 for SAP based application package at Integration Server version
	9.0 or later:
        <ul>
          <li>Place your IBM webMethods Adapter 4.6 for SAP based application
	    ...
	    IBM webMethods Adapter 4.6 for SAP based application package</li>
          <li>Click <em>Install Release</em></li>
        </ul>
      </li>
      <li>You are now ready to finish migration of the IBM webMethods Adapter 4.6 for SAP constructs to the IBM webMethods Adapter 10.1 for SAP
    ...
    <div class="note">
      <p><strong>Note.</strong> IBM webMethods Adapter 4.6 for SAP usually did populate the
	...
	encoded string. For more details about the IBM webMethods Adapter 10.1 for SAP type system 
	see the IBM webMethods Adapter 10.1 for SAP User's Guide Appendix C, available from the
	<a href="https://docs.webmethods.io/">IBM Documentation
	    Web site</a>.<br/>
